...
/* @var $searchModel backend\models\PendidikanTerakhirSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Pendidikan Terakhirs';
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);

?>
<div class="pendidikan-terakhir-index">
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> Yii::t('yii2-ajaxcrud', 'Create New').' Pendidikan Terakhirs','class'=>'btn btn-outline-primary']).
